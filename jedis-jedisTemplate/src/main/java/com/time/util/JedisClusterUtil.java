 ...
 * @author yonghao.tang
 * @version 1.0.0
 * @ClassName JedisClusterUtil.java
...
public class JedisClusterUtil implements IJedisTemplate {
    ...
    @PostConstruct
    public void init() {
        log.info("JedisClusterUtil is created");
    }
    ...
    public Long pexpireAt(String key, Long milliseconds) {
        return jedisCluster.pexpireAt(key, milliseconds);
    }
    ...
    public Long hset(String key, String fields, String value) {
        return jedisCluster.hset(key, fields, value);
    }
    ...
    public Long zadd(String key, Map<String, Double> params) {
        return jedisCluster.zadd(key, params);
    }
